...
@Component({
    ...
    standalone: true,
    imports: [WelcomeComponent, OverallVisitorsComponent, PatientsLast7DaysComponent, PatientAdmissionsDischargesComponent, EmergencyRoomVisitsComponent, CriticalPatientsComponent, BedOccupancyRateComponent,  ScheduleAppointmentComponent, PatientByAgeComponent, HospitalEarningsComponent],
